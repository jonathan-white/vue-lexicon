...
export default {
  oxfordSingleWord: function(wordId) {
    return axios.get(`https://od-api.oxforddictionaries.com/api/v2/entries/en-us/${wordId}?strictMatch=false`,{
      headers: {
  ...
  oxfordSynonyms: function(wordId) {
    return axios.get(`https://od-api.oxforddictionaries.com/api/v2/entries/en-us/${wordId}/synonyms`, {
      headers: {
        "Accept": "application/json",
        "app_id": process.env.VUE_APP_OXFORD_APP_ID,
        "app_key": process.env.VUE_APP_OXFORD_APP_KEY
